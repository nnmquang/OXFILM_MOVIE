            ...
            <div className="flex flex-wrap -mx-4 -mb-10 text-center">
                <div className="sm:w-1/2 mb-10 px-4">
                    <form onSubmit={formik.handleSubmit}>
                        <h1 className="text-white text-3xl">Thêm người dùng</h1>
                        <div className='mt-5'>
                            <input style={{ backgroundColor: '#14162b' }} type="text" className="block  w-96 p-3 rounded mb-4" name="taiKhoan" onChange={formik.handleChange} placeholder="Tài khoản" />
                            <input style={{ backgroundColor: '#14162b' }} type="text" className="block  w-96 p-3 rounded mb-4" name="matKhau" onChange={formik.handleChange} placeholder="Mật khẩu" />
                            <input style={{ backgroundColor: '#14162b' }} type="text" className="block  w-96 p-3 rounded mb-4" name="hoTen" onChange={formik.handleChange} placeholder="Họ tên" />
                            <input style={{ backgroundColor: '#14162b' }} type="text" className="block  w-96 p-3 rounded mb-4" name="email" onChange={formik.handleChange} placeholder="Email" />
                            <input style={{ backgroundColor: '#14162b' }} type="text" className="block  w-96 p-3 rounded mb-4" name="soDt" onChange={formik.handleChange} placeholder="Số điện thoại" />
                            ...
                            <div className='flex justify-center'>
                                <button type="submit" className="inline-flex text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-blue-800 rounded text-lg">Thêm</button>
                            </div>
                        </div>
