...
export default function Login(props) {
  ...
  return (
    ...
    <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
        <h2 className="text-center text-4xl text-sky-300 font-display font-semibold lg:text-left xl:text-5xl
            ...
            <div>
                ...
                <div className="mt-8">
                  ...
                  cursor-pointer">
                    ...
                    <input type="password" name="matKhau" onChange={formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  placeholder="Nhập mật khẩu của bạn" />
                </div>
                <div className="mt-10">
